    ...
    for epoch in range(start_epoch, config["training"]["num_epochs"]):
        ...
        for batch in train_loader:
            ...
            with torch.no_grad():
                ...
                # DSID embeddings
                E_id  = dsid.extract_identity_embedding(I_id)     # [B, 512]
                E_sem = dsid.extract_semantic_embedding(I_ref)     # [B, 512]
            ...
            with torch.cuda.amp.autocast(dtype=torch.float16):
                # Noise prediction via U-Net (with MRF replacing cross-attention)
